...
class iImageNet(DataHandler):    
    ...
    def data(validation_split=0.):
        traindir = os.path.join("/work/u9019394/data/seed_1993_subset_100_imagenet/data", 'train')
        valdir = os.path.join("/work/u9019394/data/seed_1993_subset_100_imagenet/data", 'val')
        #traindir = os.path.join("/mnt/work/data/seed_1993_subset_100_imagenet/data", 'train')
        #valdir = os.path.join("/mnt/work/data/seed_1993_subset_100_imagenet/data", 'val')
